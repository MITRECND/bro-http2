...
export {
	...
	## Creates a URL from an :bro:type:`HTTP2::Info` record.  This should
	## handle edge cases such as proxied requests appropriately.
	##
	## rec: An :bro:type:`HTTP2::Info` record.
	##
	...
	global build_url_http2: function(rec: Info): string;
...
function build_url_http2(rec: Info): string
	{

...
decoder/analyzer for [Zeek](https://www.zeek.org/) 3. If you need this capability
for older instances of Zeek (Bro), i.e., 2.6.x or older, please refer to the last
`0.4.x` release of this plugin.
